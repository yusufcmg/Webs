...
const Project = () => {
  ...
  if (error) {
    return <div className="text-center py-20 text-red-500">Proje yüklenirken bir hata oluştu: {error}</div>;
  }
    ...
    <>
      ...
      <main className="py-20 px-4 sm:px-6 lg:px-8">
        <article className="max-w-3xl mx-auto">
          ...
          {/* GitHub bağlantısı eklendi */}
          {project.github_url && (
            <a
              href={project.github_url}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium transition-colors duration-300 mt-4"
            >
              GitHub'da Görüntüle{' '}
