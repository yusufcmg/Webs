...
const AllProjects = () => {
    ...
    useEffect(() => {
        const fetchAllProjects = async () => {
            try {
                // Tüm projeleri almak için limit'i daha yüksek bir sayıya ayarla veya kaldır
    ...
    if (loading) {
        return <div className="text-center py-20 min-h-screen-minus-header-footer">Tüm projeler yükleniyor...</div>;
    }

    if (error) {
        return <div className="text-center py-20 text-red-500 min-h-screen-minus-header-footer">Tüm projeler yüklenirken bir hata oluştu: {error}</div>;
    }
        ...
        <>
            ...
            <main className="py-20 px-4 sm:px-6 lg:px-8 min-h-screen-minus-header-footer">
                <div className="max-w-7xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 text-center">Tüm Projeler</h1>
                                ...
                                <div className="p-6">
                                    ...
                                    {project.github_url && (
                                        <a
                                            ...
                                            className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium transition-colors duration-300 mt-4 ml-2" // Adjust styling as needed
                                        >
                                            GitHub →
                                        </a>
                                    )}
